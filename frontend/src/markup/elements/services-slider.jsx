								...
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature1">
										...
										<div className="icon-content">
											...
											<p>Precision diagnostics for women's health, ensuring personalized care and peace of mind.</p>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Gynecology</h3>
											<p>Comprehensive gynecological care, tailored for every woman's unique health journey.</p>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature3">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Fertility Medication</h3>
											<p>Unlock the path to parenthood with our tailored fertility medication solutions.</p>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature1">
										...
										<div className="icon-content">
											...
											<p>Empowering gynecology patients with comprehensive vaccine solutions for a healthier tomorrow.</p>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										<div className="feature-box-xl mb-20">
											<span className="">
											<img src={ivf} className="ivf-img" alt=""/>
											</span> 
										</div>
										<div className="icon-content">
											<h3 className="ttr-title">In Vitro Fertilization</h3>
											<p>Pioneering dreams of parenthood through advanced In Vitro Fertilization expertise.</p>
										</div>
									</div>
								</div>
							</Slider>
