				...
				<section className="section-area section-sp5 work-area" style={{backgroundImage: "url("+bg1+")", backgroundRepeat:" no-repeat", backgroundPosition: "center", backgroundSize: "100%"}}>
					<div className="container-sm">
						<div className="heading-bx text-center">
							...
							<h2 className="title">Process for treatment?</h2>
						</div>
							...
							<div className="col-lg-4 col-sm-6 mb-30">
								<div className="work-bx">
									...
									<div className="work-content">
										...
										<p>Contact the clinic for prior appointment or just walk in to the clinic to meet the doctor.</p>
									</div>
							...
							<div className="col-lg-4 col-sm-6 mb-30">
								<div className="work-bx active">
									...
									<div className="work-content">
										...
										<p>With wide variety of treatments available in the clinic, </p>
									</div>
