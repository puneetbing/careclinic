...
import aboutThumb2 from '../../images/about/Sangeeta-Gomes.png';
							...
							<div className="col-lg-6 mb-30">
								<div className="about-thumb-area">
									<ul>
										...
										<li><div className="exp-bx">28+ <span>Years Experience</span></div></li>
									</ul>
								</div>
							</div>
							<div className="col-lg-6 mb-30">
								<div className="heading-bx">
									<h6 className="title-ext text-secondary">About Doctor</h6>
									<h2 className="title">Dr. Sangeeta Gomes</h2>
									<p>Dr. D.Sangeeta Gomes is the Senior Obstetrician, Gynecologist, and one of the best infertility specialists. 
									<br/><br/>
									She completed her MBBS from Gandhi Medical College, Hyderabad in the year 1994 and her MD in Obstetrics & Gynecology from Osmania Medical College, Hyderabad in 1998.</p>
								</div>
								<div className="row">
